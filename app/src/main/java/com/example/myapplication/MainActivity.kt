...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn.setOnClickListener {
            ...
            dialog.setNegativeButton("自訂義的Toast") { dialogInterface, i -> showToast() }
    ...
    private fun showListDialog() {
        ...
        dialog_list.setItems(list) { dialogInterface, i -> Toast.makeText(this@MainActivity, "你選得是" + list[i], Toast.LENGTH_SHORT).show() }
        dialog_list.show()
    }
}